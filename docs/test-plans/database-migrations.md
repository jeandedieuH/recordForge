...
| `test_fresh_db_sets_version` | New empty database | `app_meta.schema_version = 9` (export options/attempts, standalone webcam paths, and compatible upload jobs persisted) |
...
|------|------|----|----------|
| `test_migrate_v0_to_v9` | Empty DB (version 0) | 9 | All tables created, media job options/attempts and `recordings.webcam_path` available, compatible upload jobs available, version = 9 |
