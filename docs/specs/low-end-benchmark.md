...
| **Microphone** | Built-in laptop mic or USB headset | DirectShow-compatible |
...
| System audio only (WASAPI) | Loopback capture works | Requires Stereo Mix device |
| Mic + system (separate) | Independent tracks | Mixed into single track |
