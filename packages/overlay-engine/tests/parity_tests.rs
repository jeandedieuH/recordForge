...
fn parity_test_renders_fixture_project_overlays() {
    ...
    let project_json: serde_json::Value =
        serde_json::from_str(&json_content).expect("parse project JSON");
                        ...
                        match kind {
                            "annotation" => {
                                items.push(OverlayItem::Annotation {
                                    ...
                                    details: AnnotationDetails {
                                        annotation_type: clip["annotationType"]
                                            .as_str()
                                            .unwrap_or("rectangle")
                                            .to_string(),
                                        ...
                                        stroke_style: clip["strokeStyle"]
                                            .as_str()
                                            .unwrap_or("solid")
                                            .to_string(),
                                        fill_color: clip["fillColor"]
                                            .as_str()
                                            .unwrap_or("#38bdf8")
                                            .to_string(),
                                        fill_opacity: clip["fillOpacity"].as_f64().unwrap_or(0.0),
                                        corner_radius: clip["cornerRadius"].as_f64().unwrap_or(0.0),
                                        arrow_end_head: clip["arrowEndHead"]
                                            .as_str()
                                            .unwrap_or("none")
                                            .to_string(),
                                        arrow_start_head: clip["arrowStartHead"]
                                            .as_str()
                                            .unwrap_or("none")
                                            .to_string(),
                            ...
                            "text" => {
                                items.push(OverlayItem::Text {
                                    base,
                                    details: TextDetails {
                                        preset_id: clip["presetId"]
                                            .as_str()
                                            .unwrap_or("title-modern")
                                            .to_string(),
                                        category: clip["category"]
                                            .as_str()
                                            .unwrap_or("title")
                                            .to_string(),
                                        primary_text: clip["primaryText"]
                                            .as_str()
                                            .unwrap_or("")
                                            .to_string(),
                                        secondary_text: clip["secondaryText"]
                                            .as_str()
                                            .map(String::from),
                                        ...
                                        text_color: clip["textColor"]
                                            ...
                                            .unwrap_or("#ffffff")
                                            .to_string(),
                                        secondary_text_color: clip["secondaryTextColor"]
                                            .as_str()
                                            .unwrap_or("#94a3b8")
                                            .to_string(),
                                        accent_color: clip["accentColor"]
                                            .as_str()
                                            .unwrap_or("#38bdf8")
                                            .to_string(),
                                        backdrop_style: clip["backdropStyle"]
                                            .as_str()
                                            .unwrap_or("glass")
                                            .to_string(),
                                        backdrop_color: clip["backdropColor"]
                                            .as_str()
                                            .unwrap_or("#0f172a")
                                            .to_string(),
                                        backdrop_opacity: clip["backdropOpacity"]
                                            .as_f64()
                                            .unwrap_or(0.8),
                                        backdrop_blur: clip["backdropBlur"]
                                            .as_f64()
                                            .unwrap_or(16.0),
                                        backdrop_border_radius: clip["backdropBorderRadius"]
                                            .as_f64()
                                            .unwrap_or(16.0),
                                        backdrop_padding_x: clip["backdropPaddingX"]
                                            .as_f64()
                                            .unwrap_or(24.0),
                                        backdrop_padding_y: clip["backdropPaddingY"]
                                            .as_f64()
                                            .unwrap_or(18.0),
                                        shadow_enabled: clip["shadowEnabled"]
                                            .as_bool()
    ...
    assert_eq!(
        items.len(),
        4,
        "all 4 overlay fixture clips should be parsed"
    );
    ...
    let mut engine =
        OverlayEngine::from_render_plan(plan).expect("construct overlay engine from fixture");
    engine
        .register_image_svg("asset-external-logo", &logo_svg_bytes)
        .expect("register SVG image asset");
    ...
    for &time_ms in &timestamps_to_verify {
        ...
        let mut pixmap =
            tiny_skia::Pixmap::new(canvas_width, canvas_height).expect("create canvas pixmap");
        engine
            .render_to_pixmap(time_ms, &mut pixmap)
            .expect("render frame to pixmap");
