/* @ts-self-types="./cursor_engine.d.ts" */

export class WasmCursorEngine {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmCursorEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     * @returns {string}
     */
    evaluate_motion_plan(motion_plan_json, time_ms) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(motion_plan_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmcursorengine_evaluate_motion_plan(this.__wbg_ptr, ptr0, len0, time_ms);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    fit(source_x, source_y, target_width, target_height, padding) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmcursorengine_fit(this.__wbg_ptr, source_x, source_y, target_width, target_height, padding);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    constructor(telemetry_json, options_json) {
        const ptr0 = passStringToWasm0(telemetry_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmcursorengine_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cursor_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
